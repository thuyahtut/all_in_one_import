...
class ImportStore(models.Model):
    ...
    def check_sh_import_coa(self):
        ...
        if record.sh_technical_name == 'sh_import_chart_of_account':
            value = True
        return value

    import_coa_type = fields.Selection(related='base_id.import_coa_type',readonly=False, string="Import File Type")
    sh_import_coa_boolean = fields.Boolean(
        "Import COA Boolean", default=check_sh_import_coa)
    ...
    def perform_the_action(self, record):
        ...
        if record.base_id.sh_technical_name == 'sh_import_chart_of_account':
            self.import_coa(record)
        return res

    def import_coa(self,record):
        self = record
        ...
        if self and self.sh_file:
            ...
            if self.import_coa_type == 'csv' or self.import_coa_type == 'excel':
                counter = 1
                skipped_line_no = {}
                row_field_dic = {}
                row_field_error_dic = {}
                ...
                try:
                    ...
                    elif self.import_coa_type == 'excel':
